...
export async function sendAnswer() {
  ...
  answer.answer2 = parseInt(
    document.getElementById("selectUnderstandability").value
  );
  answer.answer3 = parseInt(
    document.getElementById("selectPracticality").value
  );
  answer.answer4 = parseInt(document.getElementById("selectTools").value);
  answer.answer5 = parseInt(
    document.getElementById("selectCommunication").value
  );
  answer.answer6 = parseInt(
    document.getElementById("selectInformativeness").value
  );
  ...
  answer.answer10 = parseInt(
    document.getElementById("selectFriendliness").value
  );
  answer.answer11 = parseInt(
    document.getElementById("selectPreferences").value
  );
