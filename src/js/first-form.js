...
function checkStorage() {
  console.log(
    "Сейчас обрабатывается рендер educationLevelSelect--" +
      localStorage.getItem("educationLevelSelect") +
      " yearSelect--" +
...
function educationFormFill() {
  ...
  getAllEducationalForm().then((res) => {
    ...
    if (localStorage.getItem("educationalFormSelect")) {
      educationalFormSelect.value = localStorage.getItem(
        "educationalFormSelect"
      );
    }
  });
