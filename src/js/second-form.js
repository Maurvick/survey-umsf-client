...
export function createLecturerForm() {
  ...
  divUnderstandability.innerHTML =
    '<label for="selectUnderstandability">' +
  ...
  divPracticality.innerHTML =
    '<label for="selectPracticality">' +
  ...
  divCommunication.innerHTML =
    '<label for="selectCommunication">' +
  ...
  divInformativeness.innerHTML =
    '<label for="selectInformativeness">' +
  ...
  divObjectivity.innerHTML =
    '<label for="selectObjectivity">' +
  ...
  divConferences.innerHTML =
    '<label for="selectConferences">' +
  ...
  divFriendliness.innerHTML =
    '<label for="selectFriendliness">' +
  ...
  divPreferences.innerHTML =
    '<label for="selectPreferences">' +
